        ...
        <div className="w-[450px] h-max p-3 rounded-xl border-blue-200 border-6 shadow-xl ">
            ...
            <div className="font-semibold flex items-center">
               ...
               Referral Link:      
                    ...
                    <div className="w-full bg-white p-2 border-gray-200 border-2 rounded-md flex flex-wrap">
               {`https://kishalaycare.in/signin?referal=${user?.userid}&name=${user?.name}`}
               </div>
                </div>
               <div className="w-5 h-5 ml-3 cursor-pointer" onClick={() =>{
                navigator.clipboard.writeText(`https://kishalaycare.in/signin?referal=${user?.userid}&name=${user?.name}`);
