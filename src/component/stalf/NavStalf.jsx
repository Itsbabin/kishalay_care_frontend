...
import { SetShowebleHomeStalf0 } from "@/app/(stalf)/stalf/page";
...
export default function NavStalf() {
    ...
    <>
      <nav className="fixed top-0 left-0 bg-[#e4f8ff] shadow-lg z-40">
        ...
        <div className="container h-16 mx-auto flex justify-between items-center">
          ...
          <div
            className="flex justify-between items-center space-x-2 md:mr-0 mr-7 cursor-pointer"
            onClick={() => {
        ...
        >
          <div
            className="text-black group py-0.5 text-xl font-semibold pl-2 w-full cursor-pointer"
            onClick={() => {}}
          >
            ...
            <div className=" cursor-pointer group-hover:h-22 group-hover:pt-2 group-hover:pl-4 h-0 text-lg flex flex-col gap-1 overflow-hidden duration-300">
              <div
                className="w-5/6 pl-4 py-1 hover:bg-blue-300 rounded-xl"
                onClick={() => {
                  SetShowebleHomeStalf0("JoiningForm");
                }}
              >
                New Joing
              </div>
              <div
                className="w-5/6 pl-4 py-1 hover:bg-blue-300 rounded-xl"
                onClick={() => {
                  SetShowebleHomeStalf0("SearchAgent");
                }}
              >
                Search User
              </div>
          ...
          <div
            ...
            onClick={() => {}}
          >
            <div className="hover:bg-blue-300 px-4 py-1 rounded-xl">
              Business Plan
            </div>
            <div className=" cursor-pointer group-hover:h-30 group-hover:pt-2 group-hover:pl-4 h-0 text-lg flex flex-col gap-1 overflow-hidden duration-300">
              <div
                className="w-5/6 pl-4 py-1 hover:bg-blue-300 rounded-xl"
                onClick={() => {
                  SetShowebleHomeStalf0("BusenessPlan");
                }}
              >
                View Plan
              </div>
