...
export default function SearchAgent() {
  ...
  return (
    <>
    <div className="h-full w-full flex flex-col justify-baseline items-center gap-6 overflow-y-scroll">
    <div className="">Search Agents</div>
      ...
      <div className="flex justify-center items-center flex-wrap space-x-1 w-full h-80  overflow-y-scroll gap-3 bg-blue-100 p-4">
      {
        SearchResult.map((e) =>{
          return (
